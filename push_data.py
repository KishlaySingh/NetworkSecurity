...
if __name__ == "__main__":
    ...
    records = NetworkDataExtract.cv_to_json_convertor(file_path=FILE_PATH)
    print(records)
    no_of_records = NetworkDataExtract.insert_data_to_mongo(records, database=DATABASE, collection=COLLECTION)
